...
// Function to adjust button transform styles based on screen size
...
// Event listener for window resizing to adjust the styles dynamically
window.addEventListener('resize', adjustButtonTransforms);
